...
export const ABOUT_FAQ: FaqItem[] = [
	...
	},
	{
		...
		a: `כותבים לנו לכתובת ${CONTACT_EMAIL} — לשאלות, להצעות ולדיווח על תקלה. אפשר גם לפנות דרך ערוצי הרשתות החברתיות שמופיעים בתחתית הדף. ברשימת "צוות הרכזים" בדף הזה רואים מי הרכז האחראי על כל אתר ברשת, כדי לדעת למי לפנות בנושא ספציפי.`
	}
];
