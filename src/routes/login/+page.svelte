...
<div class="min-h-[80vh] flex items-center justify-center px-4 py-12" dir="rtl">
	<div class="w-full max-w-md rounded-3xl border border-white/10 bg-[#0f172a] p-8 shadow-2xl">
		...
		<button
			...
			class="mb-3 flex w-full items-center justify-center gap-2 rounded-2xl bg-linear-to-r/oklch from-amber-500 to-pink-600 px-4 py-3.5 font-bold text-white transition hover:from-amber-400 hover:to-pink-500"
		>
